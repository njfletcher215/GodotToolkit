...
/// <summary>
/// A mediator between a vertical slider and its title, current value, and tick labels.
/// </summary>
public partial class VLabeledSlider : VSlider {
    /// <summary>
    ...
    private void InitializeTickLabels() {
        ...
        for (int i = 0; i < this.TickCount; i++) {
            ...
            Label tickLabel = new Label {
                Text = val.ToString("0.##"),
                Position = new Vector2(this.Size.X, pos),
            };

            // vertically center the tickLabel on pos
            tickLabel.Position -= new Vector2(0, tickLabel.Size.Y / 2);
